...
function preload(){
  ...
  mainRacerImg1 = loadAnimation("tigerrunning.gif");
  mainRacerImg2= loadAnimation("lionhappy.png");
  
  oppPink1Img = loadAnimation("runningdeer.gif");
  oppPink2Img = loadAnimation("opponent3.png");
  
  oppYellow1Img = loadAnimation("runingwolf.gif"); 
  //fox
  oppYellow2Img = loadAnimation("opponent6.png");
  
  oppRed1Img = loadAnimation("runningfox.gif");
